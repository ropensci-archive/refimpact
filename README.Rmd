...
Using the double `[` notation allows you to access the nested data as a
data.frame object - essentially a data.frame within a data_frame. You can still
use the double `[` syntax for accessing normal values, so it's a good habit to
get into.
